This project was originally developed by DERI  for Google Refine and and added following functionalities:
...
The repository has been forked and updated to work with OpenRefine, next version of Google Refine.
